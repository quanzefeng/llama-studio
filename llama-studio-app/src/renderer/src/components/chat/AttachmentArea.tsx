  ...
  return (
    <div className="relative shrink-0">
      <button
        ...
        className={`w-8 h-8 flex items-center justify-center rounded-full text-[var(--c-muted)] hover:text-[var(--c-text)] disabled:opacity-30 transition-colors ${className ?? ''}`}
      >
